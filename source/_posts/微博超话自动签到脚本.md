...
tags: [JavaScript]
categories:
thumbnail: https://raw.githubusercontent.com/NavePnow/blog_photo/master/IMG_1189.JPG
recommend: 1
top: 
toc: true
---
...
- **配置获取cookie脚本**
	将 [get_cookie_surge.js][9] 保存在 Surge/Scripts 下面，在配置文件中添加如下代码
...
- **配置签到脚本**
	1. 将 [checkin_surge.js][12] 保存在 Surge/Scripts 下面，打开脚本，修改部分内容
...
- **配置获取cookie脚本**
	将 [get_cookie_qx.js][14]保存在 QuantumultX/Scripts 下面，在配置文件中添加如下代码
...
- **配置签到脚本**
	1. 将 [checkin_qx.js][17] 保存在 QuantumultX/Scripts 下面，打开脚本，修改部分内容
